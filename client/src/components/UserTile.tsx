...
const UserTile = ({ name, img }: Props) => {
  ...
  return (
    ...
    >
      ...
      <MenuList className="bg-[#0e131e]" placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
        <MenuItem
          className="flex items-center gap-2 bg-[#0e131e] hover:bg-[#0e131e]"
          onClick={logOut} placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}        >
